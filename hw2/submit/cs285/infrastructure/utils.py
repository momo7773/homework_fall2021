...
def sample_trajectories(env, policy, min_timesteps_per_batch, max_path_length, render=False, render_mode=('rgb_array')):
    # TODO: get this from hw1
    # sample batch_size number of trajectories, each trajectory has ep_len timesteps. => len(path) = batch_size
    #path[0]: dict, path[0]['observation'] is a nparray, dim(ep_len, )
